...
public class WerewolfModel extends AbstractWerewolfModel<AbstractWerewolfRenderState> {
	...
	public static LayerDefinition getTexturedModelData() {
		...
		PartDefinition cube_r3 = body.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(38, 30).addBox(-2.0F, -1.0F, -1.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.2881F, -3.3487F, 0.3054F, 0.0F, 0.0F));
		...
		PartDefinition ears = head.addOrReplaceChild("ears", CubeListBuilder.create(), PartPose.offset(0.0F, 18.0F, -2.0F));

		PartDefinition cube_r7 = ears.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(20, 41).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.001F))
		.texOffs(40, 6).addBox(-5.0F, -2.0F, -1.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.001F)), PartPose.offsetAndRotation(2.0F, -22.5F, -2.25F, 0.3054F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = jaw.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(24, 0).addBox(-2.0F, -1.0F, -4.0F, 4.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.25F, -0.5F, 0.3054F, 0.0F, 0.0F));

		PartDefinition jaw_teeth = jaw.addOrReplaceChild("jaw_teeth", CubeListBuilder.create(), PartPose.offset(0.0F, 17.0F, 2.0F));

		PartDefinition cube_r9 = jaw_teeth.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(34, 24).addBox(0.0F, -1.0F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.001F))
		...
		PartDefinition cube_r10 = upper_mouth.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(16, 19).addBox(-2.0F, -1.0F, -4.0F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.25F, -0.5F, -0.3054F, 0.0F, 0.0F));
		...
		PartDefinition cube_r11 = upper_teeth.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(42, 11).addBox(0.0F, -1.1041F, -1.1761F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.001F))
		.texOffs(42, 9).addBox(-1.5F, -1.1041F, -1.1761F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.001F))
		.texOffs(42, 3).addBox(-3.0F, -1.1041F, -1.1761F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.001F)), PartPose.offsetAndRotation(1.0F, 16.75F, -5.5F, -0.3054F, 0.0F, 0.0F));

		PartDefinition horns = body.addOrReplaceChild("horns", CubeListBuilder.create(), PartPose.offset(0.0F, 6.7119F, -3.5987F));

		PartDefinition cube_r12 = horns.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(16, 36).addBox(0.25F, -1.0F, -1.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.75F, -10.25F, 4.5F, 0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r13 = horns.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(8, 39).addBox(0.25F, -1.0F, -1.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.75F, -13.25F, 6.5F, 0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r14 = horns.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(38, 34).addBox(0.25F, -1.0F, -1.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.75F, -15.0F, 6.75F, 0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r15 = horns.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(42, 0).addBox(0.25F, -1.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.75F, -16.75F, 6.0F, 0.3054F, 0.0F, 0.0F));

		PartDefinition tail = body.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(16, 41).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, 2.0F));
		...
		PartDefinition cube_r16 = right_shoulder_bicep.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(26, 26).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.25F, 0.0F, 0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r17 = right_shoulder_bicep.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(34, 38).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.5F, 0.0F, 0.3054F, 0.0F, 0.0F));
		...
		PartDefinition cube_r18 = right_elbow.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(0, 25).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(-0.001F)), PartPose.offsetAndRotation(0.0F, 1.75F, 0.0F, -0.2182F, 0.0F, 0.0F));
		...
		PartDefinition cube_r19 = left_shoulder_bicep.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(26, 32).addBox(-1.0F, -2.0F, -2.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.75F, 0.0F, 0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r20 = left_shoulder_bicep.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(0, 39).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3054F, 0.0F, 0.0F));
		...
		PartDefinition cube_r21 = left_elbow.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(8, 25).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(-0.001F)), PartPose.offsetAndRotation(-1.0F, 1.75F, 0.0F, -0.2182F, 0.0F, 0.0F));
