...
public class WerewolfModel extends AbstractWerewolfModel<AbstractWerewolfRenderState> {
    public static final EntityModelLayer WEREWOLF =
		new EntityModelLayer(Identifier.of(VoidDimension.MOD_ID, "werewolf"), "main");
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData ears = head.addChild("ears", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 18.0F, -2.0F));
		...
		ModelPartData tail = body.addChild("tail", ModelPartBuilder.create().uv(16, 41).cuboid(-0.5F, 0.0F, 0.0F, 1.0F, 5.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -1.0F, 2.0F));
