...
public class CorruptedWarriorModel extends EntityModel<CorruptedWarriorRenderState> {
    public static final EntityModelLayer CORRUPTED_WARRIOR =
		new EntityModelLayer(Identifier.of(VoidDimension.MOD_ID, "corrupted_warrior"),
							 "main");

	private final Animation idleAnimation;
	private final Animation walkAnimation;
	private final Animation strongAttackAnimation;
	private final Animation strongestAttackAnimation;
	private final Animation summonProjectileAnimation;
	private final Animation specialAttackAnimation;
	private final Animation normalAttack1Animation;
	private final Animation normalAttack2Animation;
	private final Animation normalAttack3Animation;
	...
	public CorruptedWarriorModel(ModelPart root) {
		...
		this.idleAnimation = CorruptedWarriorAnimations.IDLE.createAnimation(root);
		this.walkAnimation = CorruptedWarriorAnimations.WALK.createAnimation(root);
		this.strongAttackAnimation = CorruptedWarriorAnimations.STRONG_ATTACK.createAnimation(root);
		this.strongestAttackAnimation = CorruptedWarriorAnimations.STRONGEST_ATTACK.createAnimation(root);
		this.summonProjectileAnimation = CorruptedWarriorAnimations.SUMMON_PROJECTILE.createAnimation(root);
		this.specialAttackAnimation = CorruptedWarriorAnimations.SPECIAL_ATTACK.createAnimation(root);
		this.normalAttack1Animation = CorruptedWarriorAnimations.NORMAL_ATTACK_1.createAnimation(root);
		this.normalAttack2Animation = CorruptedWarriorAnimations.NORMAL_ATTACK_2.createAnimation(root);
		this.normalAttack3Animation = CorruptedWarriorAnimations.NORMAL_ATTACK_3.createAnimation(root);
	}
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData body = root.addChild("body", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -17.0F, 0.0F));

		ModelPartData head = body.addChild("head", ModelPartBuilder.create().uv(0, 55).cuboid(-5.0F, -10.0F, -4.75F, 10.0F, 10.0F, 10.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -20.0F, -0.25F));
		...
		.uv(54, 13).cuboid(-7.0F, -10.0F, -2.0F, 12.0F, 10.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		...
		.uv(64, 81).cuboid(-7.0F, -14.0F, 8.0F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		...
		.uv(40, 25).cuboid(0.0F, -12.0F, -5.0F, 18.0F, 9.0F, 6.0F, new Dilation(0.0F)), ModelTransform.origin(-9.0F, -8.0F, 2.0F));
		...
		.uv(80, 13).cuboid(17.0F, -3.0F, -1.0F, 1.0F, 5.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));

		ModelPartData body_decoration = torso.addChild("body_decoration", ModelPartBuilder.create(), ModelTransform.origin(9.0F, -12.0F, 1.0F));

		ModelPartData cape = body_decoration.addChild("cape", ModelPartBuilder.create().uv(0, 25).cuboid(-9.5F, 0.0F, 1.0F, 19.0F, 27.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, -1.0F));

		ModelPartData skirt = body_decoration.addChild("skirt", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 20.0F, -4.0F));

		ModelPartData arms = body.addChild("arms", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -20.0F, 0.0F));
		...
		.uv(22, 100).cuboid(-5.0F, 2.0F, -2.0F, 4.0F, 8.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(-8.25F, 0.0F, 0.0F));
		...
		.uv(24, 75).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 10.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(-3.0F, 10.0F, 0.0F));
		...
		.uv(0, 90).cuboid(-4.0F, 16.0F, -4.0F, 2.0F, 2.0F, 9.0F, new Dilation(0.0F)), ModelTransform.origin(2.0F, -18.0F, 0.0F));

		ModelPartData guard = grip.addChild("guard", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		...
		.uv(80, 103).cuboid(-4.0F, 16.5F, -31.75F, 2.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(2.0F, -18.0F, 0.0F));
		...
		.uv(100, 55).cuboid(1.0F, 2.0F, -2.0F, 4.0F, 8.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(8.25F, 0.0F, 0.0F));
		...
		.uv(48, 89).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 10.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(3.0F, 10.0F, 0.0F));

		ModelPartData legs = root.addChild("legs", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -16.0F, 0.0F));

		ModelPartData right_leg = legs.addChild("right_leg", ModelPartBuilder.create().uv(88, 13).cuboid(-3.0F, 0.0F, -3.0F, 6.0F, 8.0F, 6.0F, new Dilation(0.0F)), ModelTransform.origin(-5.0F, -1.0F, 0.0F));
		...
		.uv(40, 57).cuboid(-4.0F, 0.0F, -1.0F, 8.0F, 9.0F, 8.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 8.0F, -3.0F));

		ModelPartData left_leg = legs.addChild("left_leg", ModelPartBuilder.create().uv(88, 85).cuboid(-3.0F, 0.0F, -3.0F, 6.0F, 8.0F, 6.0F, new Dilation(0.0F)), ModelTransform.origin(5.0F, -1.0F, 0.0F));
		...
		.uv(40, 57).cuboid(-4.0F, 0.0F, -2.0F, 8.0F, 9.0F, 8.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 8.0F, -2.0F));
		return TexturedModelData.of(modelData, 128, 128);
	}

    @Override
	public void setAngles(CorruptedWarriorRenderState state) {
		...
		this.strongAttackAnimation.apply(
			state.strongAttackAnimationState, state.age, 1f
		);

		this.strongestAttackAnimation.apply(
			state.strongestAttackAnimationState, state.age, 1f
		);

		this.summonProjectileAnimation.apply(
			state.summonProjectileAnimationState, state.age, 1f
		);

		this.specialAttackAnimation.apply(
			state.specialAttackAnimationState, state.age, 1f
		);

		this.normalAttack1Animation.apply(
			state.normalAttack1AnimationState, state.age, 1f
		);

		this.normalAttack2Animation.apply(
			state.normalAttack2AnimationState, state.age, 1f
		);

		this.normalAttack3Animation.apply(
			state.normalAttack3AnimationState, state.age, 1f
		);
