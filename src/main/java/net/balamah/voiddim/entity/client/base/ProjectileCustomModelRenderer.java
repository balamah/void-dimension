...
public abstract class ProjectileCustomModelRenderer
	<T extends Projectile, S extends EntityRenderState, M extends EntityModel<? super S>>
	...
	implements RenderLayerParent<S, M>
{
	...
	public static int getOverlayCoords(
		...
		return OverlayTexture.pack(OverlayTexture.u(whiteOverlayProgress), OverlayTexture.v(true));
	}
