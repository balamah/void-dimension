...
public class WormOfCorruptionModel extends EntityModel<WormOfCorruptionRenderState> {
    public static final EntityModelLayer WORM_OF_CORRUPTION =
		new EntityModelLayer(Identifier.of(VoidDimension.MOD_ID, "worm_of_corruption"),
							 "main");
	...
	private final Animation digUpAnimation;
	private final Animation digDownAnimation;
	...
	public WormOfCorruptionModel(ModelPart root) {
		...
		this.idleAnimation = WormOfCorruptionAnimations.IDLE.createAnimation(root);
		this.attackAnimation = WormOfCorruptionAnimations.ATTACK.createAnimation(root);
		this.shootAnimation = WormOfCorruptionAnimations.SHOOT.createAnimation(root);
		this.digUpAnimation = WormOfCorruptionAnimations.DIG_UP.createAnimation(root);
		this.digDownAnimation = WormOfCorruptionAnimations.DIG_DOWN.createAnimation(root);
	}
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData worm = root.addChild("worm", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -18.25F, 1.75F));

		ModelPartData head = worm.addChild("head", ModelPartBuilder.create(), ModelTransform.of(0.0F, -13.0F, -5.0F, 0.2182F, 0.0F, 0.0F));

		ModelPartData mouth = head.addChild("mouth", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 29.9289F, -0.6493F));
		...
		.uv(148, 167).cuboid(0.75F, -35.0F, 6.0F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 34.0F, 8.0F));

		ModelPartData lower = mouth.addChild("lower", ModelPartBuilder.create().uv(64, 48).cuboid(-8.0F, -1.0F, -15.0F, 16.0F, 6.0F, 16.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -30.0F, 7.0F));
		...
		.uv(58, 129).cuboid(0.75F, -35.0F, -7.0F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 32.0F, -7.0F));

		ModelPartData head_horns = head.addChild("head_horns", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));

		ModelPartData horn_1 = head_horns.addChild("horn_1", ModelPartBuilder.create().uv(118, 167).cuboid(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 3.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -4.0F, 8.0F));

		ModelPartData horn_2 = head_horns.addChild("horn_2", ModelPartBuilder.create().uv(52, 113).cuboid(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 8.0F));

		ModelPartData horn_3 = head_horns.addChild("horn_3", ModelPartBuilder.create().uv(50, 122).cuboid(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 5.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 4.0F, 8.0F));

		ModelPartData horn_4 = head_horns.addChild("horn_4", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 8.0F, 8.0F));

		ModelPartData body = worm.addChild("body", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 18.25F, -1.75F));

		ModelPartData body_1 = body.addChild("body_1", ModelPartBuilder.create().uv(64, 70).cuboid(-8.0F, -5.0F, 0.0F, 16.0F, 5.0F, 16.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, -8.0F));

		ModelPartData body_2 = body.addChild("body_2", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -5.0F, -8.0F));
		...
		ModelPartData body_3 = body.addChild("body_3", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -10.0F, -8.0F));
		...
		ModelPartData body_4 = body.addChild("body_4", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -15.0F, -8.0F));
		...
		ModelPartData body_5 = body.addChild("body_5", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -20.0F, -8.0F));
		...
		ModelPartData bone = miasma.addChild("bone", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -1.0F, -9.0F));
		...
		ModelPartData overlay = miasma.addChild("overlay", ModelPartBuilder.create().uv(0, 0).cuboid(-24.0F, 1.5F, -15.0F, 46.0F, 0.0F, 48.0F, new Dilation(0.0F)), ModelTransform.origin(1.0F, -1.0F, -9.0F));

		ModelPartData horns = root.addChild("horns", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		return TexturedModelData.of(modelData, 208, 208);
	}

    @Override
    public void setAngles(WormOfCorruptionRenderState state) {
        super.setAngles(state);

		this.idleAnimation.apply(state.idleAnimationState, state.age);
		this.attackAnimation.apply(state.attackAnimationState, state.age);
		this.shootAnimation.apply(state.shootAnimationState, state.age);
		this.digUpAnimation.apply(state.digUpAnimationState, state.age);
		this.digDownAnimation.apply(state.digDownAnimationState, state.age);
    }
}
