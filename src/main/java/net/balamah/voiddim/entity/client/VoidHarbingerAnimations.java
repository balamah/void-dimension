...
public class VoidHarbingerAnimations {
	...
	public static final AnimationDefinition SHOOT = AnimationDefinition.Builder.create(0.29167f)
	...
	public static final AnimationDefinition SUMMON = AnimationDefinition.Builder.create(0.9167666f)
	.addBoneAnimation("right_arm",
		new Transformation(Transformation.Targets.ROTATE,
			new Keyframe(0f, AnimationHelper.createRotationalVector(0f, 0f, 0f),
				Transformation.Interpolations.LINEAR),
	...
	.addBoneAnimation("right_elbow",
		new Transformation(Transformation.Targets.ROTATE,
			...
			new Keyframe(0.3433333f, AnimationHelper.createRotationalVector(0f, 0f, 48.41f),
				Transformation.Interpolations.LINEAR))).build();
	public static final AnimationDefinition SUMMON_END = AnimationDefinition.Builder.create(0.375f)
	.addBoneAnimation("right_arm",
		new Transformation(Transformation.Targets.ROTATE,
