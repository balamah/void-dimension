...
public class CorruptedStalkerModel extends EntityModel<BasicRenderState> {
    public static final EntityModelLayer CORRUPTED_STALKER =
		new EntityModelLayer(Identifier.of(VoidDimension.MOD_ID, "corrupted_stalker"),
							 "main");
	...
	public CorruptedStalkerModel(ModelPart root) {
		...
		this.walkingAnimation = BasicAnimations.WALK.createAnimation(root);
	}
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData head = root.addChild("head",
			...
			ModelTransform.origin(0.0F, -38.0F, 0.0F));

		ModelPartData arms = root.addChild("arms", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));

		ModelPartData left_arm = arms.addChild("left_arm", ModelPartBuilder.create().uv(28, 0).cuboid(-1.0F, 0.0F, -2.0F, 2.0F, 28.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -38.0F, -4.0F));

		ModelPartData right_arm = arms.addChild("right_arm", ModelPartBuilder.create().uv(28, 30).cuboid(-1.0F, 0.0F, 0.0F, 2.0F, 28.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -38.0F, 4.0F));

		ModelPartData body = root.addChild("body", ModelPartBuilder.create().uv(0, 0).cuboid(-2.0F, -38.0F, -4.0F, 4.0F, 14.0F, 8.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));

		ModelPartData legs = root.addChild("legs", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -24.0F, 1.0F));

		ModelPartData left_leg = legs.addChild("left_leg", ModelPartBuilder.create().uv(0, 36).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 24.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 1.0F));

		ModelPartData right_leg = legs.addChild("right_leg", ModelPartBuilder.create().uv(36, 0).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 24.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, -3.0F));
