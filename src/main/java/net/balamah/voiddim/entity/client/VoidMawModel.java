...
public class VoidMawModel extends EntityModel<VoidMawRenderState> {
    public static final EntityModelLayer VOID_MAW =
		new EntityModelLayer(Identifier.of(VoidDimension.MOD_ID, "void_maw"),
							 "main");
	...
	public VoidMawModel(ModelPart root) {
		...
		this.attackAnimation = VoidMawAnimations.ATTACK.createAnimation(root);
	}

	public static TexturedModelData getTexturedModelData() {
		ModelData modelData = new ModelData();
		ModelPartData modelPartData = modelData.getRoot();
		ModelPartData root = modelPartData.addChild("root", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 19.0F, 0.0F));

		ModelPartData mouth = root.addChild("mouth", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 17.0F, 0.0F));

		ModelPartData upper = mouth.addChild("upper", ModelPartBuilder.create().uv(56, 18).cuboid(-6.0F, -6.0F, -12.0F, 12.0F, 6.0F, 12.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -18.0F, 6.0F));

		ModelPartData horns = upper.addChild("horns", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 1.0F, -6.0F));
		...
		.uv(48, 58).cuboid(4.5F, 5.0F, -1.0F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(-4.0F, -6.0F, -10.0F));

		ModelPartData lower = mouth.addChild("lower", ModelPartBuilder.create().uv(56, 0).cuboid(-6.0F, 0.0F, -12.0F, 12.0F, 6.0F, 12.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -18.0F, 6.0F));
		...
		.uv(24, 58).cuboid(4.5F, -7.0F, -1.0F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(-4.0F, 6.0F, -10.0F));

		ModelPartData main_decoration = root.addChild("main_decoration", ModelPartBuilder.create(), ModelTransform.origin(-0.75F, 0.0F, 0.0F));

		ModelPartData overlay = main_decoration.addChild("overlay", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -14.0F, 0.0F));
    ...
    @Override
    public void setAngles(VoidMawRenderState state) {
