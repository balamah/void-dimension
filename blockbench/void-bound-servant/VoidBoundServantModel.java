...
public class VoidBoundServantModel extends EntityModel<VoidBoundServantEntity> {
	...
	@Override
	public void setAngles(VoidBoundServantEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	}
	@Override
