...
public class EyeBrightModel extends EntityModel<EyeBrightEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData body = root.addChild("body", ModelPartBuilder.create().uv(44, 35).cuboid(-5.0F, -18.0F, -3.0F, 9.0F, 18.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -12.0F, 0.0F));
		...
		ModelPartData flying_head_1 = heads.addChild("flying_head_1", ModelPartBuilder.create(), ModelTransform.pivot(-7.0F, -6.0F, -9.75F));
		...
		ModelPartData flying_head_2 = heads.addChild("flying_head_2", ModelPartBuilder.create(), ModelTransform.pivot(-10.5F, -0.5F, -8.5F));
		...
		ModelPartData flying_head_3 = heads.addChild("flying_head_3", ModelPartBuilder.create(), ModelTransform.pivot(-10.5F, 5.5F, -8.5F));
		...
		ModelPartData flying_head_4 = heads.addChild("flying_head_4", ModelPartBuilder.create(), ModelTransform.pivot(-10.0F, -6.0F, -8.75F));
		...
		ModelPartData arms = body.addChild("arms", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 12.0F, 0.0F));

		ModelPartData left_arm = arms.addChild("left_arm", ModelPartBuilder.create().uv(110, 89).cuboid(1.0F, 0.0F, -2.5F, 3.0F, 16.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(3.0F, -30.0F, 0.0F));

		ModelPartData head = body.addChild("head", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -18.0F, -1.0F));

		ModelPartData upper_head = head.addChild("upper_head", ModelPartBuilder.create().uv(0, 51).cuboid(-4.0F, -6.0F, -8.0F, 8.0F, 6.0F, 8.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -2.0F, 4.0F));
		...
		.uv(80, 67).cuboid(2.25F, -0.25F, -7.75F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData head_jaw = head.addChild("head_jaw", ModelPartBuilder.create().uv(56, 0).cuboid(-4.0F, 0.0F, -8.0F, 8.0F, 2.0F, 8.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -2.0F, 4.0F));
		...
		.uv(90, 78).cuboid(2.25F, -0.25F, -7.75F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.5F, -0.5F, 0.0F));

		ModelPartData jaw = body.addChild("jaw", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -18.0F, -1.0F));

		ModelPartData upper_jaw = jaw.addChild("upper_jaw", ModelPartBuilder.create().uv(102, 25).cuboid(-3.0F, 0.0F, -4.0F, 6.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		.uv(88, 6).cuboid(0.25F, 2.0F, -3.0F, 1.0F, 2.0F, 1.0F, new Dilation(-0.0001F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		.uv(102, 29).cuboid(-3.0F, 0.0F, -4.0F, 6.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 4.0F, 0.0F));
		...
		.uv(28, 65).cuboid(-0.5F, -4.0F, -3.0F, 1.0F, 3.0F, 1.0F, new Dilation(-0.0001F)), ModelTransform.pivot(0.0F, 0.25F, 0.0F));
		...
		.uv(102, 22).cuboid(0.0F, 16.0F, 2.0F, 8.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(-4.0F, 0.0F, -5.0F));

		ModelPartData body_decoration = jaw.addChild("body_decoration", ModelPartBuilder.create().uv(36, 113).cuboid(-3.0F, 0.0F, -3.0F, 6.0F, 16.0F, 0.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.25F));

		ModelPartData legs = root.addChild("legs", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -12.0F, -2.0F));

		ModelPartData right_leg = legs.addChild("right_leg", ModelPartBuilder.create().uv(110, 108).cuboid(-2.0F, 0.0F, -3.0F, 3.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(3.0F, 0.0F, 2.0F));

		ModelPartData left_leg = legs.addChild("left_leg", ModelPartBuilder.create().uv(22, 113).cuboid(-1.0F, 0.0F, -3.0F, 3.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(-4.0F, 0.0F, 2.0F));
		return TexturedModelData.of(modelData, 256, 256);
	}
	@Override
	public void setAngles(EyeBrightEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	}
	@Override
