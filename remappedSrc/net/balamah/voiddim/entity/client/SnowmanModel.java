...
public class SnowmanModel extends EntityModel<BasicRenderState> {
	public static final EntityModelLayer SNOWMAN =
		new EntityModelLayer(ResourceLocation.fromNamespaceAndPath(VoidDimension.MOD_ID, "snowman"), "main");
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData root = modelPartData.addChild("root", ModelPartBuilder.create(), ModelTransform.pivot(1.0F, 24.0F, -3.0F));

		ModelPartData base = root.addChild("base", ModelPartBuilder.create(), ModelTransform.pivot(-1.0F, 0.0F, 4.0F));
		...
		.uv(56, 0).cuboid(-14.0F, -11.0F, 2.0F, 17.0F, 9.0F, 9.0F, new Dilation(0.0F)), ModelTransform.pivot(6.0F, 0.0F, -7.0F));
		...
		.uv(52, 72).cuboid(-12.0F, -11.0F, 1.0F, 13.0F, 9.0F, 9.0F, new Dilation(0.0F)), ModelTransform.pivot(6.0F, -13.0F, -6.0F));
		...
		ModelPartData head = base.addChild("head", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -25.0F, 0.0F));
		...
		.uv(0, 100).cuboid(-2.0F, -6.0F, -5.0F, 5.0F, 5.0F, 9.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData nose = head.addChild("nose", ModelPartBuilder.create(), ModelTransform.pivot(7.5F, 2.0F, -7.0F));
		...
		ModelPartData left_arm = root.addChild("left_arm", ModelPartBuilder.create().uv(96, 86).cuboid(0.0F, -0.75F, 0.0F, 5.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(6.0F, -23.0F, 3.0F));
		...
		.uv(74, 100).cuboid(5.0F, 0.0F, -4.0F, 1.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(5.0F, -0.75F, 1.0F));

		ModelPartData right_arm = root.addChild("right_arm", ModelPartBuilder.create().uv(100, 57).cuboid(-5.0F, -0.75F, 0.0F, 5.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(-7.0F, -23.0F, 3.0F));
		...
		.uv(86, 100).cuboid(-6.0F, 0.0F, -4.0F, 1.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-5.0F, -0.75F, 1.0F));
