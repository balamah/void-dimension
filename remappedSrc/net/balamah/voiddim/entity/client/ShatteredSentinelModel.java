...
public class ShatteredSentinelModel extends BasicLivingEntityModel<ShatteredSentinelRenderState> {
    public static final EntityModelLayer SHATTERED_SENTINEL =
		new EntityModelLayer(ResourceLocation.fromNamespaceAndPath(VoidDimension.MOD_ID,
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData head = root.addChild("head", ModelPartBuilder.create().uv(0, 13).cuboid(-2.5F, -3.0F, -2.5F, 5.0F, 4.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -25.0F, 0.0F));
		...
		.uv(22, 0).cuboid(-2.25F, 0.0F, -4.0F, 5.0F, 1.0F, 4.0F, new Dilation(-0.001F)), ModelTransform.pivot(-0.25F, 1.0F, 2.5F));
		...
		.uv(42, 25).cuboid(-4.0F, -22.0F, 1.0F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData stones = body.addChild("stones", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -18.0F, 0.0F));
		...
		ModelPartData pelvis = body.addChild("pelvis", ModelPartBuilder.create().uv(20, 13).cuboid(-3.0F, -15.0F, -2.0F, 6.0F, 2.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData legs = root.addChild("legs", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -13.0F, 0.0F));

		ModelPartData left_leg = legs.addChild("left_leg", ModelPartBuilder.create().uv(40, 9).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-3.0F, 0.0F, 0.0F));

		ModelPartData left_leg_calves = left_leg.addChild("left_leg_calves", ModelPartBuilder.create().uv(0, 33).cuboid(-4.0F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(3.0F, 6.0F, 0.0F));

		ModelPartData right_leg = legs.addChild("right_leg", ModelPartBuilder.create().uv(0, 42).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(3.0F, 0.0F, 0.0F));

		ModelPartData right_leg_calves = right_leg.addChild("right_leg_calves", ModelPartBuilder.create().uv(34, 19).cuboid(2.0F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-3.0F, 6.0F, 0.0F));

		ModelPartData arms = root.addChild("arms", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -22.0F, 0.0F));

		ModelPartData left_arm = arms.addChild("left_arm", ModelPartBuilder.create().uv(34, 37).cuboid(-3.0F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-4.0F, 0.0F, 0.0F));

		ModelPartData left_arm_elbow = left_arm.addChild("left_arm_elbow", ModelPartBuilder.create().uv(26, 37).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-2.0F, 7.0F, 0.0F));

		ModelPartData right_arm = arms.addChild("right_arm", ModelPartBuilder.create().uv(38, 28).cuboid(1.0F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(4.0F, 0.0F, 0.0F));

		ModelPartData right_arm_elbow = right_arm.addChild("right_arm_elbow", ModelPartBuilder.create().uv(40, 0).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(2.0F, 7.0F, 0.0F));
