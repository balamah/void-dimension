...
public class VoidBoundServantModel
	...
	implements ModelWithArms<VoidBoundServantRenderState>
{
    public static final EntityModelLayer VOID_BOUND_SERVANT =
		new EntityModelLayer(ResourceLocation.fromNamespaceAndPath(VoidDimension.MOD_ID, "void_bound_servant"),
							 "main");
	...
	public void translateToHand(
		VoidBoundServantRenderState state, Arm arm, MatrixStack poseStack
	) {
		this.root.rotate(poseStack);
		this.body.rotate(poseStack);
		this.arms.rotate(poseStack);

		if (arm == Arm.RIGHT) {
			this.right_arm.rotate(poseStack);
			this.right_elbow.rotate(poseStack);

			poseStack.translate(0.08F, -0.1F, 0.0F);
		} else {
			this.left_arm.rotate(poseStack);
			this.left_elbow.rotate(poseStack);
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData root = modelPartData.addChild("root", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 5.0F, 0.0F));
		...
		.uv(34, 24).cuboid(-6.5F, -13.0F, -1.0F, 13.0F, 6.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 7.0F, 0.0F));

		ModelPartData head = body.addChild("head", ModelPartBuilder.create().uv(32, 10).cuboid(-3.5F, -7.0F, -3.0F, 7.0F, 7.0F, 7.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -13.0F, 0.0F));

		ModelPartData helmet = head.addChild("helmet", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -3.0F, 0.0F));
		...
		.uv(64, 33).cuboid(-6.0F, -12.0F, 5.0F, 9.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(1.5F, 6.0F, -2.0F));
		...
		.uv(66, 24).cuboid(-0.75F, 1.0F, -0.5F, 2.0F, 6.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-8.0F, 0.0F, 0.0F));
		...
		.uv(64, 54).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 10.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.25F, 7.0F, 0.5F));
		...
		.uv(0, 71).cuboid(-1.25F, 1.0F, -0.5F, 2.0F, 6.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(8.0F, 0.0F, 0.0F));
		...
		.uv(64, 66).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 10.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-0.25F, 7.0F, 0.5F));
		...
		.uv(72, 71).cuboid(-5.75F, -1.0F, -1.0F, 1.0F, 3.0F, 2.0F, new Dilation(0.001F)), ModelTransform.pivot(0.0F, -6.0F, 1.0F));

		ModelPartData bottom = root.addChild("bottom", ModelPartBuilder.create(), ModelTransform.pivot(-4.75F, 0.0F, 1.0F));
		...
		.uv(56, 41).cuboid(-0.25F, 6.0F, 0.75F, 10.0F, 9.0F, 0.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.25F));
		...
		ModelPartData decoration = bottom.addChild("decoration", ModelPartBuilder.create().uv(60, 50).cuboid(-4.25F, -24.0F, -1.0F, 0.0F, 20.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(4.75F, 30.0F, -1.0F));
