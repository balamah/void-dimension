...
public class HollowedBeastModel extends AbstractWerewolfModel<AbstractWerewolfRenderState> {
    public static final EntityModelLayer HOLLOWED_BEAST =
		new EntityModelLayer(ResourceLocation.fromNamespaceAndPath(VoidDimension.MOD_ID, "hollowed_beast"),
							 "main");
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData tail = body.addChild("tail", ModelPartBuilder.create().uv(18, 41).cuboid(-0.5F, 0.0F, 0.0F, 1.0F, 5.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -1.0F, 2.0F));
