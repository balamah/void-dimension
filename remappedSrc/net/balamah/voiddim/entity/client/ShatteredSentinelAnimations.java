...
public class ShatteredSentinelAnimations {
	...
	.addBoneAnimation("right_arm",
		new Transformation(Transformation.Targets.ROTATE,
			...
			new Keyframe(0.5834334f, AnimationHelper.createRotationalVector(42f, 0f, 0f),
				Transformation.Interpolations.LINEAR)))
		.build();
	public static final Animation ATTACK = Animation.Builder.create(0.4167667f)
	...
	public static final Animation IDLE = Animation.Builder.create(1.0834333f).looping()
	...
	public static final Animation STONES_FLOAT = Animation.Builder.create(1.0834333f).looping()
		.addBoneAnimation("stones",
			new Transformation(Transformation.Targets.TRANSLATE, 
				new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
					Transformation.Interpolations.CUBIC), 
