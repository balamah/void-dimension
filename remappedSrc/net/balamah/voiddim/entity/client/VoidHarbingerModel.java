...
public class VoidHarbingerModel extends EntityModel<VoidHarbingerRenderState> {
    public static final EntityModelLayer VOID_HARBINGER =
		new EntityModelLayer(ResourceLocation.fromNamespaceAndPath(VoidDimension.MOD_ID, "void_harbinger"),
							 "main");
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData head = root.addChild("head", ModelPartBuilder.create().uv(0, 21).cuboid(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -39.0F, 0.0F));

		ModelPartData arms = root.addChild("arms", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -24.0F, 0.0F));

		ModelPartData right_arm = arms.addChild("right_arm", ModelPartBuilder.create().uv(68, 28).cuboid(-1.0F, -1.0F, 0.0F, 2.0F, 15.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -14.0F, 7.5F));

		ModelPartData right_elbow = right_arm.addChild("right_elbow", ModelPartBuilder.create().uv(68, 62).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 14.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 14.0F, 1.0F));

		ModelPartData left_arm = arms.addChild("left_arm", ModelPartBuilder.create().uv(68, 45).cuboid(-1.0F, -1.0F, -2.0F, 2.0F, 15.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -14.0F, -7.5F));

		ModelPartData left_elbow = left_arm.addChild("left_elbow", ModelPartBuilder.create().uv(0, 69).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 14.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 14.0F, -1.0F));
		...
		.uv(0, 0).cuboid(-2.0F, -39.0F, -8.0F, 4.0F, 5.0F, 16.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		.uv(72, 22).cuboid(-1.0F, -10.0F, 5.0F, 3.0F, 5.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -24.0F, -1.0F));

		ModelPartData body_decoration = body.addChild("body_decoration", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -54.0F, 0.0F));
		...
		.uv(8, 75).cuboid(1.0F, 15.0F, 10.0F, 1.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		.uv(48, 75).cuboid(1.0F, 15.0F, -13.0F, 1.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData side = miasma.addChild("side", ModelPartBuilder.create(), ModelTransform.pivot(0.5F, -24.25F, 3.5F));
		...
		ModelPartData front = miasma.addChild("front", ModelPartBuilder.create(), ModelTransform.pivot(-1.25F, -24.25F, -3.5F));
		...
		ModelPartData back = miasma.addChild("back", ModelPartBuilder.create(), ModelTransform.pivot(1.25F, -24.25F, -3.5F));
		...
		ModelPartData decoration = miasma.addChild("decoration", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
