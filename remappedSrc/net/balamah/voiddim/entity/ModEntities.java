...
public class ModEntities {
	...
	public static final EntityType<CorruptedPlayerEntity> CORRUPTED_PLAYER =
		register(
			...
			EntityType.Builder.<CorruptedPlayerEntity>create(CorruptedPlayerEntity::new, SpawnGroup.CREATURE)
	...
	public static final EntityType<ConsumedSoulEntity> CONSUMED_SOUL =
		register(
			...
			EntityType.Builder.<ConsumedSoulEntity>create(ConsumedSoulEntity::new, SpawnGroup.MISC)
	...
	public static void registerEntityAttributes() {
		...
		FabricDefaultAttributeRegistry.register(ModEntities.CORRUPTED_BLAZE, CorruptedBlazeEntity.createBlazeAttributes());
		FabricDefaultAttributeRegistry.register(ModEntities.CORRUPTED_CREEPER, CorruptedCreeperEntity.createCreeperAttributes());
		...
		register(String name, Class<T> entityClass, EntityType.Builder<T> entityBuilder)
	{
		RegistryKey<EntityType<?>> key =
			RegistryKey.of(RegistryKeys.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(VoidDimension.MOD_ID, name)
		);
